...
<hr width="90%">
<%
	UploadModule form = (UploadModule) session.getAttribute(UploadServlet.UPLOAD_FORM); 
	if ( form != null ) {
%>
...
%><p align="center"><b>NO FORM SPECIFIED</b></p>
<%
	} } else {
...
<%
	} } } else { session.removeAttribute(UploadServlet.UPLOAD_FORM);
%><h1 style="color: red;">ACCESS DENIED</h1><% } %></div><% } else { %>		
