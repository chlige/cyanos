...
<hr width='80%' noshade size='1'>
<a href='<%= contextPath %>/upload?module=<%= UploadServlet.COLLECTION_UPLOAD_MODULE %>'>Upload Collection Data</a><br>
<a href='<%= contextPath %>/upload?module=<%= UploadServlet.ISOLATION_UPLOAD_MODULE  %>'>Upload Isolation Data</a><br>
</p></div>
</span>
<% } else { 
%></p></div>
...
<a href='<%= contextPath %>/upload?module=<%= UploadServlet.EXTRACT_UPLOAD_MODULE %>'>Upload Extract Data</a><br>
...
<a href='<%= contextPath %>/upload?module=<%= UploadServlet.SAMPLE_LIBRARY_UPLOAD_MODULE %>'>Upload Sample Data</a><br>
<hr width='80%' noshade size='1'>
...
<a href='<%= contextPath %>/upload?module=<%= UploadServlet.FRACTION_UPLOAD_MODULE  %>'>Upload New Data</a><br>
</p></div>
</span>
<% } 
...
<a href='<%= contextPath %>/upload?module=<%= UploadServlet.ASSAY_UPLOAD_MODULE  %>'>Upload Data</a><br>
</p></div>
</span>
<% } 
