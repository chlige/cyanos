...
public class SQLData {
	...
	class SQLConnection {
		...
		protected PreparedStatement prepareStatement(String sqlString, int autoGeneratedKeys) throws DataException {
			try {
				return this.dbc.prepareStatement(sqlString, autoGeneratedKeys);
			} catch (SQLException e) {
				throw new DataException(e);
			}
		}
...
//				System.out.format("SQLConnection: DB Connection CLOSE: %d\n", this.dbc.hashCode());
	...
	public PreparedStatement prepareStatement(String sqlString, boolean getKeys) throws DataException {
		return this.conn.prepareStatement(sqlString, (getKeys ? PreparedStatement.RETURN_GENERATED_KEYS : PreparedStatement.NO_GENERATED_KEYS));
	}
